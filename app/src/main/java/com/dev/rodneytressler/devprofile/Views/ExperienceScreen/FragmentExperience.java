...
public class FragmentExperience extends Fragment implements ExperienceView {
  @Inject ExperiencePresenter presenter;
  ...
  public static FragmentExperience newInstance() {
